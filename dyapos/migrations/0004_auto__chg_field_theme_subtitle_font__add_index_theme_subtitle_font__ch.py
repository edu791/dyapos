...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Theme.subtitle_font' to match new field type.
        db.rename_column(u'dyapos_theme', 'subtitle_font', 'subtitle_font_id')
        # Changing field 'Theme.subtitle_font'
        db.alter_column(u'dyapos_theme', 'subtitle_font_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dyapos.Font']))
        # Adding index on 'Theme', fields ['subtitle_font']
        db.create_index(u'dyapos_theme', ['subtitle_font_id'])


        # Renaming column for 'Theme.title_font' to match new field type.
        db.rename_column(u'dyapos_theme', 'title_font', 'title_font_id')
        # Changing field 'Theme.title_font'
        db.alter_column(u'dyapos_theme', 'title_font_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dyapos.Font']))
        # Adding index on 'Theme', fields ['title_font']
        db.create_index(u'dyapos_theme', ['title_font_id'])


        # Renaming column for 'Theme.body_font' to match new field type.
        db.rename_column(u'dyapos_theme', 'body_font', 'body_font_id')
        # Changing field 'Theme.body_font'
        db.alter_column(u'dyapos_theme', 'body_font_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dyapos.Font']))
        # Adding index on 'Theme', fields ['body_font']
        db.create_index(u'dyapos_theme', ['body_font_id'])


    def backwards(self, orm):
        # Removing index on 'Theme', fields ['body_font']
        db.delete_index(u'dyapos_theme', ['body_font_id'])

        # Removing index on 'Theme', fields ['title_font']
        db.delete_index(u'dyapos_theme', ['title_font_id'])

        # Removing index on 'Theme', fields ['subtitle_font']
        db.delete_index(u'dyapos_theme', ['subtitle_font_id'])


        # Renaming column for 'Theme.subtitle_font' to match new field type.
        db.rename_column(u'dyapos_theme', 'subtitle_font_id', 'subtitle_font')
        # Changing field 'Theme.subtitle_font'
        db.alter_column(u'dyapos_theme', 'subtitle_font', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 7, 1, 0, 0), max_length=45))

        # Renaming column for 'Theme.title_font' to match new field type.
        db.rename_column(u'dyapos_theme', 'title_font_id', 'title_font')
        # Changing field 'Theme.title_font'
        db.alter_column(u'dyapos_theme', 'title_font', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 7, 1, 0, 0), max_length=45))

        # Renaming column for 'Theme.body_font' to match new field type.
        db.rename_column(u'dyapos_theme', 'body_font_id', 'body_font')
        # Changing field 'Theme.body_font'
        db.alter_column(u'dyapos_theme', 'body_font', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 7, 1, 0, 0), max_length=45))
